...
class _ExercisePageState extends State<ExercisePage> {
  ...
  void initState() {
    ...
    if (widget.exercise.file != null) {
      _vcontroller = VideoPlayerController.network(
          APIManager().getPath(widget.exercise.file), videoPlayerOptions: VideoPlayerOptions(mixWithOthers: true))
        ..initialize().then((_) {
  ...
  void increaseView() {
    APIManager().increaseView(widget.exercise.id);
  }
